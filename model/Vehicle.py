...
class Vehicle(Model):
    ...
    fillable=["customerId", 'name', 'plateNum', 'model', 'manufacturer', 'note', 'fuel', 'engineCC', 'horsePowerBHP', 'cyilenders' ,'fuelCapacity' ,'seatingCapacity', 'vehicleWeightKG', 'status', 'condition']
