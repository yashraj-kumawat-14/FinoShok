...
class Calculator:
    def __init__(self, calcWindow, parentUpdateStatus=None):
        ...
        button7.grid(row=1, column=0, pady=1, padx=1)
        ...
        button8.grid(row=1, column=1, pady=1, padx=1)
        ...
        button9.grid(row=1, column=2, pady=1, padx=1)
        ...
        button4.grid(row=2, column=0, pady=1, padx=1)
        ...
        button5.grid(row=2, column=1, pady=1, padx=1)
        ...
        button6.grid(row=2, column=2, pady=1, padx=1)
        ...
        button1.grid(row=3, column=0, pady=1, padx=1)
        ...
        button3.grid(row=3, column=2, pady=1, padx=1)
        ...
        button0.grid(row=4, column=1, pady=1, padx=1)

        button0 = Button(buttonBox, text="0", width=6, height=2, bg=numBg, fg=numFg, font="COPPER 13 bold", command=lambda : self.operationAndNum("0"))
        button0.grid(row=4, column=1, pady=1, padx=1)

        buttonPoint = Button(buttonBox, text=".", width=6, height=2, bg=numBg, fg=numFg, font="COPPER 13 bold", command=lambda : self.operationAndNum("."))
        buttonPoint.grid(row=4, column=2, pady=1, padx=1)

        buttonBack = Button(buttonBox, text=u"\u232B", width=6, height=2, bg=numBg, fg=numFg, font="COPPER 13 bold", command=lambda : self.removeLast())
        buttonBack.grid(row=0, column=1, pady=1, padx=1)

        buttonE = Button(buttonBox, text="e", width=6, height=2, bg=numBg, fg=numFg, font="COPPER 13 bold", command=lambda : self.operationAndNum("e"))
        buttonE.grid(row=4, column=0, pady=1, padx=1)


        #operational buttons
        buttonC = Button(buttonBox, text="C", width=6, height=2, bg="red", fg="black", font="COPPER 13 bold",command=lambda : self.operationAndNum("C"))
        buttonC.grid(row=0, column=0, pady=1, padx=1)

        buttonPercentage = Button(buttonBox, text="O", width=6, fg="yellow", height=2, bg=numBg, font="COPPER 13 bold", command=lambda : self.operationAndNum("c"))
        buttonPercentage.grid(row=0, column=2, pady=1, padx=1)
        buttonPercentage.config(state="disabled")
        ...
        buttonAns.grid(row=4, column=3, pady=1, padx=1)
        
        buttonPlus = Button(buttonBox, text="+", width=5, height=2, bg=commandBg, fg=commandFg, font="COPPER 13 bold", command=lambda : self.operationAndNum("+"))
        buttonPlus.grid(row=0, column=3, pady=1, padx=1)
    ...
    def keyBoardHandler(self, event):
        if(event.char.isdigit()):
            ...
            self.operationAndNum(".")
        elif(event.keysym == "Return"):
            self.ans()
        elif(event.keysym == "BackSpace"):
            self.removeLast()
        elif(event.char.lower() == "c"):
            self.operationAndNum("c")
    ...
    #this method removes last character in self.result
    def removeLast(self):
        self.result= self.result[0:len(self.result)-1]
        self.displayVar.set(self.result if(len(self.result)>0) else "0")
